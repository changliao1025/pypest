...
def modflow_prepare_pest_run_script(sFilename_configuration_in, sModel):
    """
    ...
    ##!/share/apps/python/anaconda3.6/bin/python
    #from modflow_prepare_input_from_pest import *
    #sFilename_configuration_in='/pic/scratch/liao313/03model/swat/purgatoire30/calibration/linux_config.txt'
    #modflow_prepare_input_from_pest(sFilename_configuration_in)
    #EOF
    #
    ...
    sLine = 'from modflow_prepare_input_from_pest import *\n'
    ifs.write(sLine)
    ...
    sLine = 'sModel = ' + '"' + sModel + '"\n'
    ifs.write(sLine)
    sLine = 'modflow_prepare_input_from_pest(sFilename_configuration_in, sModel)\n'
    ifs.write(sLine)
...
if __name__ == '__main__':
    ...
    modflow_prepare_pest_run_script(sFilename_configuration_in, sModel)
